...
#ifndef _DRV_PHY_HWLIB_H    /* Guard against multiple inclusion */
#define _DRV_PHY_HWLIB_H
...
#define PHY_BCON_SOFT_RESET_MASK                    0x8000
#define PHY_BCON_AUTO_NEGOTIATION_ENABLE_MASK 		0x1000

#define PHY_INT6_MASK    0x40
#define	PHY_INT1_MASK    0x2
