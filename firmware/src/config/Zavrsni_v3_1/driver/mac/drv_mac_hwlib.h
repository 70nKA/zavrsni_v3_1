...
#ifndef _DRV_MAC_HWLIB_H    /* Guard against multiple inclusion */
#define _DRV_MAC_HWLIB_H
...
typedef enum {
    RMII_SPEED_10 = 0xFFFFFEFF,
    RMII_SPEED_100 = 0xFFFFFFFF
}RMII_SPEED_SEL;
